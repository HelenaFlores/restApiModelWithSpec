...
public class LogoutSpec {
    ...
    public static ResponseSpecification errorNoValidNokenLogoutResponseSpec = new ResponseSpecBuilder()
            ...
            .expectBody(matchesJsonSchemaInClasspath(
                    "schemas/users/logout/wrong_logout_no_valid_token_response_schema.json"))
            .expectBody("detail", notNullValue())
            .expectBody("code", notNullValue())
            .build();

    public static ResponseSpecification errorEmptyBodyLogoutResponseSpec = new ResponseSpecBuilder()
            .log(ALL)
            .expectStatusCode(400)
            .expectBody(matchesJsonSchemaInClasspath(
                    "schemas/users/logout/wrong_logout_without_token_response_schema.json"))
